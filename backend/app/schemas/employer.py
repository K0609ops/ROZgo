...
class EmployerProfileSchema(BaseModel):
    ...
    workLocations: Optional[List[Dict[str, Any]]] = Field(default_factory=list)
    hiringPreferences: Optional[Dict[str, Any]] = Field(default_factory=dict)
    bio: Optional[str] = ""
    verificationDetails: Optional[Dict[str, Any]] = Field(default_factory=dict)
